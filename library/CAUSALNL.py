...
class CausalNL:
    ...
    def evaluate_model(self):
        ...
        time_elapse = time.time() - self.time
        return max(epoch_class_accuracy1,epoch_class_accuracy2), int(epoch_class_accuracy1<epoch_class_accuracy2) ,time_elapse
    ...
    def run(self):
        ...
        save_data(os.path.join(self.args.cls_dir, self.args.data_name), self.dataset, self.device, self.net1)
        torch.save(self.net1.state_dict(), self.args.model_dir + 'classifier1.pk')
        torch.save(self.net2.state_dict(), self.args.model_dir + 'classifier2.pk')

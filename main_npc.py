...
# data
parser.add_argument('--dataset', type=str, default='MNIST', help = 'MNIST, FMNIST, CIFAR10, Clothing, Food, Webvision-mini')
...
parser.add_argument("--total_iter", type=int, default=5, help='total iter (Default : 5)')
